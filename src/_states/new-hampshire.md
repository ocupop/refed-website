...
policy_data:
  date_labeling:
    legislation:
      - title: Reg 2
        ...
        legal_citation: N.H. Code Admin. R. Agr. 1412.03.
      - title: Reg 4
        applies_to_food_type: Prewrapped Sandwiches
        ...
        legal_citation: N.H. Code Admin. R. Agr. 1412.04.
      - title:
        applies_to_food_type: Prewrapped Sandwiches
        ...
        legal_citation: N.H. Code Admin. R. Agr. 1412.01.
    label_regulation:
  ...
  animal_feed:
    legislation:
      - title: 'N.H. Rev. Stat. Ann. §§ 435:32–37'
        animals_covered: Swine
        definition_of_garbage: 'Waste consisting in whole or in part of animal waste, including any waste animal carcasses or offal from such carcasses or parts thereof, but excluding waste from ordinary household operations that is fed directly to swine on the same premises where such household is located. § 435.32.'
        prohibitions: 'No feeding untreated garbage to swine. Exception for individuals feeding household garbage. §§ 435.32, .36.'
        licensure_requirements: An individual or facility must obtain an annual permit in order to feed garbage to swine. § 435.33.
        treatment_requirements: All garbage must be heated to 212 degrees Fahrenheit for at least 30 minutes or else treated in some other manner approved by the commissioner of agriculture or the state veterinarian. § 435.36.
        enforcement: >-
          ...
          counts as a separate offense. § 435.40.
          ...
          or facility that violates the garbage-feeding rule. § 435.35.
          ...
          the state. § 435.37.
        relevant_state_regulatory_body: 'New Hampshire Department of Agriculture, Markets & Food (§ 435.37), <a href="http://agriculture.nh.gov/" target="_blank">http://agriculture.nh.gov/</a>.'
